...
class FileMemory:
    ...
    def get_metadata(self) -> tuple:
        ...
        end_hash_size = end_key_size + OTHERS_BYTES
        hash_size = int.from_bytes(
            data[end_key_size:end_hash_size], ENDIAN
        )

        end_value_size = end_hash_size + OTHERS_BYTES
        value_size = int.from_bytes(
            data[end_hash_size:end_value_size], ENDIAN
        )
        ...
        self._tree_conf = TreeConf(
            page_size, order, key_size, value_size, hash_size, self._tree_conf.serializer, self._tree_conf.hash_serializer
        )
    ...
    def set_metadata(self, root_node_page: Optional[int],
        ...
        data = (
            ...
            tree_conf.hash_size.to_bytes(OTHERS_BYTES, ENDIAN) +
